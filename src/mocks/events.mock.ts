...
export let eventsMock: Event[] = [
    ...
    new Event("92b19fc6-5386-4985-bf5c-dc56c903dd26",
        "hihi ehehe.",
        new Date("2019-09-24T23:07:01"),
        600,
        "UZS",
        new Employee("858142ac-299a-48f0-b221-7d6de9439456",
            "Alia",
            "Qassem"),
        "")
];